...
exports.PARAMETERIZED_REPLACEABLE_KINDS = void 0;
exports.createParameterizedEvent = createParameterizedEvent;
exports.validateParameterizedEvent = validateParameterizedEvent;
exports.createParameterizedEventManager = createParameterizedEventManager;
exports.createEventReplacementHandler = createEventReplacementHandler;
/**
 * Parameterized replaceable event kinds (30000-39999)
 */
exports.PARAMETERIZED_REPLACEABLE_KINDS = {
 ...
 */
function createParameterizedEvent(kind, content, identifier, additionalTags = []) {
    return ['EVENT', {
            kind,
            content,
            tags: [
 ...
 */
function validateParameterizedEvent(message, _logger) {
    try {
 ...
 */
function createParameterizedEventManager(_logger) {
    return {
 ...
 */
function createEventReplacementHandler(_logger) {
    return {
