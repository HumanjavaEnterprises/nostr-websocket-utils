...
exports.verifyNIP05Identifier = verifyNIP05Identifier;
exports.createNIP05Metadata = createNIP05Metadata;
exports.createNIP05VerificationCache = createNIP05VerificationCache;
exports.createNIP05BatchVerifier = createNIP05BatchVerifier;
 ...
 */
async function verifyNIP05Identifier(identifier, pubkey, logger) {
    try {
        // Parse identifier
        ...
        const response = await (0, http_js_1.fetchJson)(url);
 ...
 */
function createNIP05Metadata(identifier, metadata = {}) {
    return {
        ...metadata,
        nip05: identifier
    };
 ...
 */
function createNIP05VerificationCache(defaultTTL = 3600) {
    const cache = new Map();
 ...
 */
function createNIP05BatchVerifier(logger, cache) {
    const queue = new Map();
    return {
