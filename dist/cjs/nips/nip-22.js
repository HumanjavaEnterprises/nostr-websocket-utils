...
exports.DEFAULT_TIME_LIMITS = void 0;
exports.createTimeValidator = createTimeValidator;
exports.validateEventTime = validateEventTime;
exports.createTimeSyncManager = createTimeSyncManager;
/**
 * Default time limits in seconds
 */
exports.DEFAULT_TIME_LIMITS = {
 ...
 */
function createTimeValidator(logger, futureLimitSeconds = exports.DEFAULT_TIME_LIMITS.FUTURE_LIMIT, pastLimitSeconds = exports.DEFAULT_TIME_LIMITS.PAST_LIMIT) {
 ...
 */
function validateEventTime(message, validator, logger) {
    try {
 ...
 */
function createTimeSyncManager(logger) {
