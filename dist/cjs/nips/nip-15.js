...
exports.createEOSEMessage = createEOSEMessage;
exports.createSubscriptionStateManager = createSubscriptionStateManager;
exports.createPaginationHandler = createPaginationHandler;
/**
 * Creates an EOSE (End of Stored Events) message
 * @param subscriptionId - Subscription ID
 * @returns {NostrWSMessage} EOSE message
 */
function createEOSEMessage(subscriptionId) {
 ...
 */
function createSubscriptionStateManager(logger) {
 ...
 */
function createPaginationHandler(stateManager, logger) {
