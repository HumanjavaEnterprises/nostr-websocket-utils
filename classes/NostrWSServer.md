...
The ID of the client to check

#### Returns

`boolean`

boolean indicating if the client exists

#### Defined in

[server.ts:152](https://github.com/HumanjavaEnterprises/nostr-websocket-utils/blob/main/src/server.ts#L152)
